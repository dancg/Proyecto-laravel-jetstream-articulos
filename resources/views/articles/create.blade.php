    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mx-auto w-1/2 bg-gray-200 rounded-xl shadow-lg px-2 py-4">
                <form name="as" action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    focus:ring-opacity-50 rounded-md shadow-sm mt-2 w-full">{{ old('descripcion') }}</textarea>
                    ...
                    <div class="mt-2 mx-auto">
                        <img src="{{ Storage::url('noimage.jpg') }}" id="img" 
